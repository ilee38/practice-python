...
if __name__ == '__main__':
  ...
  myArray.push(21)
  print("* value at index 1: ", myArray.at(1))
  print("* new size: ", myArray.size())
  print("* new capacity: ", myArray.get_capacity())
  print("* add another item to double capacity again...")
  myArray.push(45)
  print("* value at index 2: ", myArray.at(2))
  print("* new size: ", myArray.size())
  print("* new capacity: ", myArray.get_capacity())
  print("* add another item, capacity should remain the same...")
  myArray.push(38)
  print("* value at index 3: ", myArray.at(3))
  print("* new size: ", myArray.size())
  print("* new capacity: ", myArray.get_capacity())
